...
# run FedProx
echo "Run FedProx"
python run_experiment.py shakespeare FedProx --n_learners 1 --n_rounds 120 --bz 128 --lr 0.01 --mu 0.1 \
 --lr_scheduler multi_step --log_freq 5 --device cuda --optimizer prox_sgd --seed 1234 --verbose 1


 # run FedEdg
echo "Run FedEdg"
python run_experiment.py shakespeare FedEdg --n_learners 1 --n_rounds 120 --bz 128 --lr 0.01 --mu 0.1 --lr_scheduler multi_step --log_freq 5 --device cuda --optimizer kl_sgd --seed 1234 --verbose 1
