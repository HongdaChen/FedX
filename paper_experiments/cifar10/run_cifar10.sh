...
# run FedProx
echo "Run FedProx"
python run_experiment.py cifar10 FedProx --n_learners 1 --n_rounds 201 --bz 64 --lr 0.01 --mu 1.0 --lr_scheduler multi_step --log_freq 10 --device cuda --optimizer prox_sgd --seed 1234 --verbose 1


# run FedEdg
echo "Run FedEdg"
python run_experiment.py cifar10 FedEdg --n_learners 1 --n_rounds 201 --bz 64 --lr 0.01 --mu 1.0 --lr_scheduler multi_step --log_freq 10 --device cuda --optimizer kl_sgd --seed 1234 --verbose 1
